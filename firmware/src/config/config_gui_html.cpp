...
void PrintMainHtml(WiFiClient &client, Config config){
    ...
    client.println("");
    client.println("      <label class=\"blocklabel\">Display trend arrow:</label>");
    client.println("      <input type=\"checkbox\" name=\"trend-arrow\" value=\"on\" "+CheckboxValue(getBooleanValue("trend-arrow", config))+" >");
    client.println("");
    client.println("      <label class=\"blocklabel\">Display delta:</label>");
    client.println("      <input type=\"checkbox\" name=\"delta\" value=\"on\" "+CheckboxValue(getBooleanValue("delta", config))+" >");
    client.println("");
    client.println("      <label class=\"blocklabel\">Display reading timestamp:</label>");
    client.println("      <input type=\"checkbox\" name=\"timestamp\" value=\"on\" "+CheckboxValue(getBooleanValue("timestamp", config))+" >");
    client.println("");
    ...
    client.println("");
    client.println("      <label class=\"blocklabel\">Beta channel (EXPEREMENTAL):</label>");
    client.println("      <input type=\"checkbox\" name=\"beta\" value=\"on\" "+CheckboxValue(getBooleanValue("beta", config))+" >");
    client.println("");
